...
facebook <- read.table(file = url("https://raw.githubusercontent.com/ch-bu/tutorat_statistik/master/Datasets/facebook.txt"), header = T, sep = "\t") # Facebook Datensatz
...
# die Körpergröße
studis <- read.csv(file = url("https://raw.githubusercontent.com/ch-bu/tutorat_statistik/master/02_Univariate%20deskriptive%20Statistik%201/Tutorat/studidaten.csv"), header = T, sep = ",") # Lieder Datensatz
...
# 6. Die Y-Achse heißt: "Häufigkeit"
# 7. Der Titel heißt: "Geschlecht der Studirenden im Tutorat"
...
# *TODO*: Erzeuge einen Boxplot aus dem Datensatz movies mit folgenden
# Eigenschaften: 
# 1. Die X-Achse repräsentiert die Variable 'gender'
...
# probier es aus. 
# 7. Der Titel des Boxplots ist: "Boxplot Rating unter Anbetracht von Romanzen"
