...
Bestimmt zunächst das Working-Directory auf den Ordner, in dem die `festival.txt` Datei liegt. Benutzt hierfür die Funktion `setwd()`. Hierfür drückt ihr `Strg + Umschalt + Enter` auf eurem Keyboard. 
